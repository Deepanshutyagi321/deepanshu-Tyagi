      ...
      <section id="projects" className="w-screen h-auto bg-slate-50 text-black flex flex-col items-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-10 px-4" data-aos="fade-up">
          <ProjectCard data={{
            ...
            description: "Mystery Feedback is a platform for anonymous feedback collection. Users share a unique link to receive secure and private feedback, promoting open dialogue and growth while maintaining anonymity.",
            technologies: "Next Js, React Js, MongoDB, Tailwind",
            url: "https://mystry-feedback.vercel.app/",
            github: "https://github.com/Deepanshutyagi321/MystryFeedback"
          }} />
          <ProjectCard data={{
            title: "Wanderlust",
            description: "Wanderlust is an online marketplace that connects people who want to rent out their property with those looking for accommodations, typically for short or long stays.",
            technologies: "MongoDB, Node Js, JavaScript, HTML, CSS, Bootstrap",
            url: "https://wanderlust-ym89.onrender.com/listings",
            github: "https://github.com/Deepanshutyagi321/Wanderlust"
          }} />
          <ProjectCard data={{
            title: "Simon Says Web version",
            description: "Simon is a fun memory game where players replicate increasingly complex sequences of lights and sounds by pressing colored pads in the correct order. One mistake, and it game over.",
            technologies: "JavaScript, CSS, HTML.",
            github: "https://github.com/Deepanshutyagi321/Simon_game"
          }} />
        </div>
      </section>
